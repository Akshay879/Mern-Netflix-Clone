...
function SignUpPage() {
  ...
  return (
    <div className='h-screen w-full hero-bg'>
      <header className='max-2-6xl mx-auto flex items-center justify-between p-4'>
        <Link to={"/"}>
        ...
        <div className='w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md'>
          ...
          <form className='space-y-4' onSubmit={handleSignup}>
            <div>
              ...
              focus:outline-none focus:ring' placeholder='you@example.com' id='email' value={email} onChange={(e) => setEmail(e.target.value)} />
            </div>
            ...
            <div>
              ...
              focus:outline-none focus:ring' placeholder='John Doe' id='email' value={username} onChange={(e) => setUsername(e.target.value)} />
            </div>
            ...
            <div>
              ...
              focus:outline-none focus:ring' placeholder='*******' id='email' value={password} onChange={(e) => setPassword(e.target.value)}/>
            </div>
