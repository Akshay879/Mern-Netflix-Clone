...
const SearchPage = () => {
   ...
   const handleSearch = async(e) => {
    e.preventDefault();
    try {
        const res = await axios.get(`/api/v1/search/${activeTab === "people" ? "person" : activeTab}/${searchTerm}`);
    ...
    <div className="bg-black min-h-screen text-white">
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex justify-center gap-3 mb-4">
                ...
                <button className={`py-2 px-4 rounded ${activeTab === 'people' ? 'bg-red-600':'bg-gray-800'} hover:'bg-red-700`}
                        onClick={() => handleTabClick("person")}>People</button>
            </div>
