...
function AuthScreen() {
  ...
  return (
    <div className='hero-bg relative'>
        <header className='max-2-6xl mx-auto flex items-center justify-between p-4 pb-10'>
            <img src='/netflix-logo.png' alt='Netflix logo' className='w-32 md:w-42' />
        ...
        <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
            <h1 className='text-2xl md:text-4xl font-bold mb-4'>Unlimited movies, TV shows, and more</h1>
        ...
        <div className='h-2 w-full bg-[#232323]' aria-hidden='true'/>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
                    ...
                    <div className='flex-1 text-center md:text-left'>
                        <h2 className='text-4xl md:text-5xl font-bold mb-4'>Create profile for kids</h2>
                        <p className='text-lg md:text-xl'>
